    ...
    return (
      <Layout title="お問い合わせ - 楽々省エネ計算">
        <div className="max-w-2xl mx-auto text-center py-16">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-4">お問い合わせありがとうございます</h1>
          <p className="text-gray-600 mb-8">
            お問い合わせを受け付けました。内容を確認の上、<br />
            2営業日以内にご連絡いたします。
          </p>
          <button
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="詳細なご質問・ご要望をお聞かせください"
                  />
                </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-sm text-gray-600">support@rakuraku-shoene.com</p>
