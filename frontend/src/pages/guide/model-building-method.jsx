      ...
      <Layout>
        <article className="max-w-4xl mx-auto px-4 py-8">
          ...
          <nav className="text-sm text-primary-600 mb-6">
            ...
            <Link href="/guide" className="hover:text-accent-600">ガイド</Link>
            <span className="mx-2">›</span>
            <span className="text-primary-900">モデル建物法完全ガイド</span>
          </nav>
          ...
          <header className="mb-8">
            ...
            <div className="bg-warm-50 border-l-4 border-accent-500 p-4 rounded">
          ...
          {/* 目次 */}
          <nav className="bg-warm-50 p-6 rounded-lg mb-8">
            <h2 className="text-lg font-bold text-primary-900 mb-4 flex items-center">
              <FaSearch className="mr-2" />
              目次
            </h2>
            <ol className="space-y-2 text-sm">
              <li><a href="#what-is-model-building" className="text-accent-600 hover:underline">1. モデル建物法とは？</a></li>
              <li><a href="#application-conditions" className="text-accent-600 hover:underline">2. 適用条件・適用可能な建物</a></li>
              <li><a href="#vs-standard-input" className="text-accent-600 hover:underline">3. 標準入力法との違い</a></li>
              <li><a href="#calculation-flow" className="text-accent-600 hover:underline">4. 計算の流れ・必要な情報</a></li>
              <li><a href="#advantages-disadvantages" className="text-accent-600 hover:underline">5. メリット・デメリット</a></li>
              <li><a href="#submission-requirements" className="text-accent-600 hover:underline">6. 審査機関への提出要件</a></li>
              <li><a href="#free-calculator" className="text-accent-600 hover:underline">7. 無料BEI計算ツール</a></li>
              <li><a href="#faq" className="text-accent-600 hover:underline">8. よくある質問</a></li>
            </ol>
          </nav>
          ...
          <section id="what-is-model-building" className="mb-12">
            <h2 className="text-2xl font-bold text-primary-900 mb-6 flex items-center">
              <FaBuilding className="mr-3 text-accent-600" />
              1. モデル建物法とは？
            </h2>
            ...
            <h3 className="text-xl font-semibold text-primary-900 mb-4">国土交通省告示による位置づけ</h3>
            <ul className="space-y-2 text-primary-700">
              <li className="flex items-start">
                <FaGavel className="mr-2 mt-1 text-accent-600 flex-shrink-0" />
            ...
            <div className="mt-6 p-4 bg-accent-50 border border-accent-200 rounded-lg">
              <p className="text-accent-800">
                <strong>重要：</strong>モデル建物法は<strong>標準入力法の一種</strong>です。
          ...
          <section id="vs-standard-input" className="mb-12">
              ...
              <table className="w-full border-collapse bg-white shadow-lg rounded-lg overflow-hidden">
                <thead>
                  <tr className="bg-warm-50">
                    <th className="border border-primary-300 p-4 text-left">比較項目</th>
                    <th className="border border-primary-300 p-4 text-center bg-green-50">モデル建物法</th>
                    <th className="border border-primary-300 p-4 text-center bg-warm-50">標準入力法（詳細計算）</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="border border-primary-300 p-4 font-semibold">計算時間</td>
                    <td className="border border-primary-300 p-4 text-center text-green-600">
                      <FaClock className="inline mr-1" />
                      <strong>5分程度</strong>
                    </td>
                    <td className="border border-primary-300 p-4 text-center text-primary-600">数時間〜数日</td>
                  </tr>
                  <tr className="bg-warm-50">
                    <td className="border border-primary-300 p-4 font-semibold">必要な入力情報</td>
                    <td className="border border-primary-300 p-4 text-green-600">
                      • 建物用途<br/>
                      • 延床面積<br/>
                      • エネルギー消費量（6項目）
                    </td>
                    <td className="border border-primary-300 p-4 text-primary-600">
                      • 全設備の詳細仕様<br/>
                      • 外皮性能詳細<br/>
                      • 運転スケジュール<br/>
                      • 制御システム詳細
                  ...
                  <tr>
                    <td className="border border-primary-300 p-4 font-semibold">精度</td>
                    <td className="border border-primary-300 p-4 text-center text-green-600">
                      <strong>十分</strong><br/>
                      <small>（国交省認定）</small>
                    </td>
                    <td className="border border-primary-300 p-4 text-center text-primary-600">
                      <strong>高精度</strong><br/>
                      <small>（実測値に近い）</small>
                    </td>
                  </tr>
                  <tr className="bg-warm-50">
                    <td className="border border-primary-300 p-4 font-semibold">審査対応</td>
                    <td className="border border-primary-300 p-4 text-center text-green-600">
                  ...
                  <tr>
                    <td className="border border-primary-300 p-4 font-semibold">コスト</td>
                    <td className="border border-primary-300 p-4 text-center text-green-600">
                      <FaMoneyBillWave className="inline mr-1" />
                      <strong>安価</strong>
                    </td>
                    <td className="border border-primary-300 p-4 text-center text-primary-600">高コスト</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="bg-accent-50 border border-accent-200 rounded-lg p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-accent-700">
                <div>
                ...
                <div>
                  <h4 className="font-semibold text-primary-700 mb-2">詳細計算がおすすめ</h4>
                  <ul className="text-sm space-y-1">
                    <li>• 高効率設備を多用</li>
                    <li>• 特殊な制御システム</li>
          ...
          <section id="calculation-flow" className="mb-12">
            <h2 className="text-2xl font-bold text-primary-900 mb-6 flex items-center">
              <FaCalculator className="mr-3 text-accent-600" />
              4. 計算の流れ・必要な情報
            </h2>
            ...
            <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
              ...
              <div className="bg-warm-50 border border-primary-200 rounded-lg p-6">
                <div className="flex items-center mb-4">
                  <div className="bg-accent-600 text-white rounded-full w-8 h-8 flex items-center justify-center font-bold mr-3">1</div>
                  <h3 className="text-lg font-semibold text-primary-800">基本情報入力</h3>
                </div>
              ...
              <div className="bg-warm-50 border border-primary-200 rounded-lg p-6">
                <div className="flex items-center mb-4">
                  <div className="bg-accent-600 text-white rounded-full w-8 h-8 flex items-center justify-center font-bold mr-3">2</div>
                  <h3 className="text-lg font-semibold text-primary-800">エネルギー消費量入力</h3>
                </div>
                <ul className="space-y-2 text-primary-700 text-sm">
                  <li>• 暖房エネルギー消費量</li>
                  <li>• 冷房エネルギー消費量</li>
              ...
              <div className="bg-warm-50 border border-primary-200 rounded-lg p-6">
                <div className="flex items-center mb-4">
                  <div className="bg-accent-600 text-white rounded-full w-8 h-8 flex items-center justify-center font-bold mr-3">3</div>
                  <h3 className="text-lg font-semibold text-primary-800">自動計算・結果出力</h3>
                </div>
                <ul className="space-y-2 text-primary-700 text-sm">
                  <li>• BEI値の自動算出</li>
                  <li>• 適合性判定</li>
            ...
            {/* BEI計算式 */}
            <div className="bg-warm-50 border border-primary-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-primary-900 mb-4">BEI計算式</h3>
              ...
              <div className="mt-4 grid md:grid-cols-2 gap-4 text-sm">
                <div>
                  <h4 className="font-semibold text-primary-800">設計一次エネルギー消費量</h4>
                  <p className="text-primary-600">実際の建物で消費する年間エネルギー量（入力値）</p>
                </div>
                <div>
                  <h4 className="font-semibold text-primary-800">基準一次エネルギー消費量</h4>
                  <p className="text-primary-600">標準原単位 × 延床面積で算出される基準値</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section id="advantages-disadvantages" className="mb-12">
            <h2 className="text-2xl font-bold text-primary-900 mb-6 flex items-center">
              <FaChartLine className="mr-3 text-accent-600" />
              5. メリット・デメリット
            </h2>
          ...
          <section id="submission-requirements" className="mb-12">
            ...
            <div className="bg-warm-50 border border-primary-200 rounded-lg p-6 mb-6">
              <h3 className="text-lg font-semibold text-primary-800 mb-3">基本的な提出書類</h3>
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <h4 className="font-semibold text-primary-700 mb-2">必須書類</h4>
                ...
                <div>
                  <h4 className="font-semibold text-primary-700 mb-2">補足資料</h4>
                  <ul className="space-y-1 text-sm text-primary-600">
                    <li>• 使用機器リスト</li>
                    <li>• エネルギー消費量根拠資料</li>
                    <li>• 運転条件設定書</li>
            ...
            <div className="bg-accent-50 border border-accent-200 rounded-lg p-6">
              ...
              <ul className="space-y-2 text-accent-700">
                <li className="flex items-start">
                  <span className="bg-accent-200 text-accent-800 px-2 py-1 rounded text-xs font-semibold mr-3 mt-0.5">注意</span>
          ...
          <section id="free-calculator" className="mb-12">
            ...
            <div className="bg-warm-50 border border-primary-200 rounded-lg p-8 text-center">
              ...
              <div className="grid md:grid-cols-3 gap-4 mb-8">
                <div className="bg-white p-4 rounded-lg shadow">
                  <FaClock className="text-accent-600 text-2xl mb-2 mx-auto" />
                  <h4 className="font-semibold">5分で完了</h4>
                  <p className="text-sm text-primary-600">簡単入力でBEI計算</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow">
                  <FaFileDownload className="text-accent-600 text-2xl mb-2 mx-auto" />
                  <h4 className="font-semibold">PDF・Excel出力</h4>
                  <p className="text-sm text-primary-600">審査対応の計算書生成</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow">
                  <FaGavel className="text-primary-600 text-2xl mb-2 mx-auto" />
                  <h4 className="font-semibold">国交省準拠</h4>
                  <p className="text-sm text-primary-600">正式な法令に完全対応</p>
                </div>
              </div>

              <Link
                href="/register"
                className="inline-flex items-center bg-accent-600 hover:bg-accent-700 text-white font-bold py-4 px-8 rounded-lg shadow-xl transition-colors text-lg"
              >
          ...
          <section id="faq" className="mb-12">
            <h2 className="text-2xl font-bold text-primary-900 mb-6 flex items-center">
              <FaSearch className="mr-3 text-accent-600" />
              8. よくある質問（FAQ）
            </h2>
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={index} className="bg-warm-50 border border-primary-200 rounded-lg p-6">
                  <h3 className="text-lg font-semibold text-primary-900 mb-3 flex items-start">
                    <span className="bg-accent-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-0.5 flex-shrink-0">Q</span>
                    {faq.q}
                  </h3>
                  <div className="pl-9">
                    <div className="flex items-start">
                      ...
                      <p className="text-primary-700 leading-relaxed">{faq.a}</p>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div className="bg-primary-800 text-white rounded-lg p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/register"
                className="bg-white text-primary-800 hover:bg-warm-100 font-bold py-3 px-6 rounded-lg transition-colors"
              >
                無料アカウント作成
              </Link>
              <Link
                href="/login"
                className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-primary-800 font-bold py-3 px-6 rounded-lg transition-colors"
              >
                ログインして開始
              </Link>
            </div>
