    ...
    <Layout title="本格運用ガイド - 楽々省エネ計算">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">本格運用セットアップガイド</h1>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <h3 className="font-semibold text-yellow-800">⚠️ 本格運用には設定必要</h3>
              <ul className="text-sm text-yellow-700 space-y-1 ml-4">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900">Google OAuth 設定</h2>
                <p className="text-gray-600">Googleアカウントでのログイン機能</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="font-semibold text-gray-900 mb-2">2. 環境変数設定</h3>
...
NEXTAUTH_URL=https://sena-sakuramoto.github.io/energy-calc-service`}
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900">メール認証システム</h2>
                <p className="text-gray-600">独自メール/パスワード認証機能</p>
              </div>
            </div>
            
            <div className="space-y-4">
              <div className="bg-blue-50 p-4 rounded-lg">
                <h3 className="font-semibold text-gray-900 mb-2">バックエンドAPI構築が必要</h3>
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <h3 className="font-semibold text-gray-900 mb-2">必要なAPI endpoints</h3>
                <pre className="bg-gray-800 text-white p-3 rounded text-xs overflow-x-auto">
...
PUT  /api/projects/:id   # プロジェクト更新`}
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900">Cloud Database設定</h2>
                <p className="text-gray-600">Firebase Firestore設定</p>
              </div>
            </div>
            
            <div className="space-y-4">
              <div className="bg-green-50 p-4 rounded-lg">
                <h3 className="font-semibold text-gray-900 mb-2">Firebase プロジェクト設定</h3>
                <ol className="text-sm text-gray-700 space-y-2 ml-4">
                  <li>1. <a href="https://console.firebase.google.com/" target="_blank" rel="noopener" className="text-blue-600 hover:underline">Firebase Console</a> でプロジェクト作成</li>
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                <h3 className="font-semibold text-gray-900 mb-2">Firestore設定ファイル</h3>
                <pre className="bg-gray-800 text-white p-3 rounded text-xs overflow-x-auto">
{`# .env.local に追加
...
NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET=あなたのストレージバケット`}
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900">本格デプロイメント</h2>
                <p className="text-gray-600">商用レベルのホスティング設定</p>
              </div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <h3 className="font-semibold text-gray-900">推奨ホスティング</h3>
                <div className="space-y-3">
                  ...
                  <div className="bg-gray-50 p-3 rounded">
                    ...
                    <p className="text-sm text-gray-600">Railway / Render / Heroku</p>
                  </div>
                  <div className="bg-gray-50 p-3 rounded">
                    <h4 className="font-medium">Database</h4>
                    <p className="text-sm text-gray-600">Firebase / PlanetScale / Supabase</p>
                  </div>
                </div>
              </div>
              
              <div className="space-y-4">
                <h3 className="font-semibold text-gray-900">セキュリティ設定</h3>
                <div className="space-y-3">
                  <div className="bg-gray-50 p-3 rounded">
                  ...
                  <div className="bg-gray-50 p-3 rounded">
                    ...
                    <p className="text-sm text-gray-600">プラットフォーム設定画面</p>
                  </div>
                  <div className="bg-gray-50 p-3 rounded">
                    <h4 className="font-medium">CORS設定</h4>
                    <p className="text-sm text-gray-600">本番ドメイン限定</p>
                  </div>
                </div>
              </div>
            </div>
